 ...
 *
 * Note that the encoding does not pad with equal signs , as discussed in
...
public class Base64Utils {
	 ...
	 */
	public static final void encode(byte[] src, int srcOff, int len,  byte[] dst,
			int dstOff) {
	 ...
	 */
	public static final void decode(byte[] src, int srcOff, int len,  byte[] dst,
			int dstOff) {
		dst[dstOff] = (byte)
